...
badd +17 NERD_tree_1
badd +2 ~/aws.env
badd +80 kernel/src/main/q/ptk.q
badd +2 kernel/src/main/q/gtr.q
badd +12 ~/PTK_ROOT/lib/heimdall/middleware/src/main/q/cb.q
badd +0 ~/PTK_ROOT/lib/heimdall/maintenance/src/main/q/job.std.q
badd +0 maintenance/src/main/q/job.q
argglobal
silent! argdel *
set stal=2
edit ~/PTK_ROOT/lib/heimdall/middleware/src/main/q/cb.q
...
exe 'vert 2resize ' . ((&columns * 121 + 135) / 271)
exe 'vert 3resize ' . ((&columns * 117 + 135) / 271)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
wincmd w
argglobal
if bufexists('kernel/src/main/q/ptk.q') | buffer kernel/src/main/q/ptk.q | else | edit kernel/src/main/q/ptk.q | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 121 + 135) / 271)
exe 'vert 3resize ' . ((&columns * 117 + 135) / 271)
tabedit maintenance/src/main/q/job.q
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
silent! normal! zE
3,59fold
let s:l = 62 - ((61 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
wincmd w
argglobal
if bufexists('~/PTK_ROOT/lib/heimdall/maintenance/src/main/q/job.std.q') | buffer ~/PTK_ROOT/lib/heimdall/maintenance/src/main/q/job.std.q | else | edit ~/PTK_ROOT/lib/heimdall/maintenance/src/main/q/job.std.q | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
exe 'vert 2resize ' . ((&columns * 121 + 135) / 271)
exe 'vert 3resize ' . ((&columns * 117 + 135) / 271)
tabedit kernel/src/main/q/gtr.q
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((7 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
