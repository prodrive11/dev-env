...
silent only
cd /mnt/vmdisk01/prodrive11/PTK_BIN/thor-core
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +16 my_trade_history_oracle/Cargo.toml
badd +11 my_trade_history_oracle/rusty-tags.vi
badd +1 my_trade_history_oracle/my_trade_history_oracle.toml
badd +130 my_trade_history_oracle/src/main.rs
badd +59 messages/src/lib.rs
badd +47 bin_serde/src/lib.rs
badd +13 messages/src/timestamps.rs
badd +1 rkdb/src/api.rs
badd +18 my_market_events_oracle/Cargo.toml
badd +31 mark_price/src/averages.rs
badd +2 ~/workspace/thor-core/my_market_events_oracle/src/main.rs
badd +10 /mnt/vmdisk01/prodrive11/PTK_BIN/thor-core/udp/src/lib.rs
badd +28 ~/workspace/thor-core/Cargo.toml
badd +1 ~/workspace/thor-core/rkdb/src/k.rs
badd +7 ~/workspace/thor-core/rkdb/demos/embed/Cargo.toml
badd +23 ~/workspace/thor-core/rkdb/Cargo.toml
badd +52 ~/workspace/thor-core/rkdb/README.md
badd +4 ~/workspace/thor-core/rkdb/src/lib.rs
badd +1 ~/workspace/thor-core/rkdb/src/kapi.rs
badd +1 ~/workspace/thor-core/my_market_events_oracle/my_market_events_oracle.toml
badd +14 /mnt/vmdisk01/prodrive11/PTK_BIN/thor-core/configuration/src/settings.rs
badd +13 my_market_events_oracle/src/lib.rs
badd +268 ~/workspace/thor-core/rkdb/src/kbindings.rs
badd +63 ~/workspace/thor-core/rkdb/src/types.rs
badd +18 ~/workspace/thor-core/rkdb/demos/ipc/src/main.rs
badd +89 ~/workspace/thor-core/rkdb/demos/embed/src/lib.rs
badd +1 ~/workspace/thor-core/my_trade_history_oracle/README.md
argglobal
silent! argdel *
set stal=2
edit my_trade_history_oracle/src/main.rs
...
silent! normal! zE
let s:l = 527 - ((27 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
527
normal! 010|
tabedit ~/workspace/thor-core/my_trade_history_oracle/README.md
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
3
normal! 03|
tabedit ~/workspace/thor-core/my_market_events_oracle/my_market_events_oracle.toml
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 31 + 57) / 115)
exe 'vert 2resize ' . ((&columns * 102 + 57) / 115)
tabedit /mnt/vmdisk01/prodrive11/PTK_BIN/thor-core/udp/src/lib.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((25 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
normal! 0
tabedit rkdb/src/api.rs
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 104 - ((6 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
wincmd w
argglobal
if bufexists('~/workspace/thor-core/rkdb/src/kbindings.rs') | buffer ~/workspace/thor-core/rkdb/src/kbindings.rs | else | edit ~/workspace/thor-core/rkdb/src/kbindings.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
