...
set shortmess=aoO
badd +0 order_gatekeeper/src/main.rs
badd +0 matching_engine/src/matching.rs
badd +0 matching_engine/src/match_server.rs
badd +0 matching_engine/src/lib.rs
badd +0 matching_engine/src/main.rs
badd +0 mjolnir/src/main.rs
badd +0 my_market_events_oracle/src/lib.rs
argglobal
silent! argdel *
$argadd order_gatekeeper/src/main.rs
set stal=2
edit order_gatekeeper/src/main.rs
...
silent! normal! zE
let s:l = 209 - ((19 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
normal! 013|
tabedit my_market_events_oracle/src/lib.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((15 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
normal! 08|
tabedit order_gatekeeper/src/main.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 139 - ((7 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
normal! 059|
tabedit mjolnir/src/main.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((7 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
normal! 015|
tabedit matching_engine/src/matching.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit matching_engine/src/match_server.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 269 - ((33 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
269
normal! 022|
tabedit matching_engine/src/lib.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal! 0
tabedit matching_engine/src/main.rs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
