...
inoremap <C-Tab> 	
imap <silent> <F3> <Plug>SelectBuf
xmap , <Plug>Sneak_,
omap , <Plug>Sneak_,
nmap , <Plug>Sneak_,
map ; :execute "vimgrep/" . expand("<cword>") . "/j `cat ~/index`" | cw
xmap S <Plug>VSurround
nmap S <Plug>Sneak_S
xmap Z <Plug>Sneak_S
omap Z <Plug>Sneak_S
nmap \sbl <Plug>SelBufLaunchCmd
nmap <silent> \n <Plug>MarkClear
...
noremap <SNR>23_DashGlobalSearch :Dash!
noremap <SNR>23_DashSearch :Dash
...
silent only
cd ~/workspace/other-core/rkdb/src
...
silent! normal! zE
let s:l = 119 - ((24 * winheight(0) + 34) / 68)
